...
type ServiceInfo struct {
	...
	LoadType    int       `json:"load_type" gorm:"column:load_type" description:"负载类型 0=http 1=tcp 2=grpc"` //负载类型
	...
	CreatedAt   time.Time `json:"create_at" gorm:"column:create_at" description:"创建时间"`                     //创建时间
	IsDelete    int       `json:"is_delete" gorm:"is_delete" description:"是否删除;0:否;1:是"`                    //是否删除
}
